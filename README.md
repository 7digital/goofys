...
* On Linux, install via [pre-built binaries](https://github.com/7digital/goofys/releases/latest/download/goofys). You may also need to install fuse-utils first.
...
$ go get github.com/7digital/goofys
$ go install github.com/7digital/goofys
```
...
See also: [Instruction for Azure Blob Storage or Azure Data Lake Gen1](https://github.com/7digital/goofys/blob/master/README-azure.md).

Got more questions? Check out [questions other people asked](https://github.com/7digital/goofys/issues?utf8=%E2%9C%93&q=is%3Aissue%20label%3Aquestion%20)
...
[bench.sh](https://github.com/7digital/goofys/blob/master/bench/bench.sh). [Raw data](https://github.com/7digital/goofys/blob/master/bench/)
...
```ShellSession
$ sudo docker run -e BUCKET=$TESTBUCKET -e CACHE=false --rm --privileged --net=host -v /tmp/cache:/tmp/cache 7digital/goofys-bench
# result will be written to $TESTBUCKET
```

See also: [cached benchmark result](https://github.com/7digital/goofys/blob/master/bench/cache/README.md) and [result on Azure](https://github.com/7digital/goofys/blob/master/bench/azure/README.md).
